...
The project has been implemented using Python 3.9 (Python 3.10 or later should also work) and version 0.38.0 of the *PennyLane* library. The implementation also makes use of the *cmath*, *numpy*, *matplotlib*, *autograd*, *scipy*, *os*, *re*, *csv*, *pickle*, *sympy*, *time*, *qiskit 1.2* modules. Some of these are already present in a base Python installation, while others are dependent on the installed *PennyLane* module, such as *scipy* and *numpy*.
